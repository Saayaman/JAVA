...
public class Board extends JPanel implements Runnable, Commons { 
    ...
    private final String alienpix = "images/alien.png";
    private String message = "All your base and female`s are belong to us..";
    ...
    public void animationCycle()  {
        ...
        if (deaths == NUMBER_OF_ALIENS_TO_DESTROY) {
            ingame = false;
            message = "You have saved the world and all the female`s want to have sex with you!";
        }
        ...
        while (it.hasNext()) {
            ...
            if (alien.isVisible()) {
                ...
                if (y > GROUND - ALIEN_HEIGHT) {
                	havewon = false;
                    ingame = false;
                    message = "Aliens stole our female`s for mindless sexgames!!";
                }
